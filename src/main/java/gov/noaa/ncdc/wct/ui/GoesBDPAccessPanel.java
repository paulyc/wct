...
//	https://s3.amazonaws.com/noaa-goes16
	...
	static {
		...
		prodCodeLookup.put("ABI-L1b-RadM1", "Radiances, Mesoscale, every 30 sec.");
		prodCodeLookup.put("ABI-L1b-RadM2", "Radiances, Mesoscale, every 30 sec.");
...
//		this.add(hourList);
	...
	private void listProducts() {
		...
		try {
			...
			listModel.addElement("ABI-L1b-RadM1");
			listModel.addElement("ABI-L1b-RadM2");
...
//        OR_ABI-L1b-RadM1-M6C01_G16_s20200120000284_e20200120000341_c20200120000392.nc
