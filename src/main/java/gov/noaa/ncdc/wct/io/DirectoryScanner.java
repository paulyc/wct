...
public class DirectoryScanner {
	...
	public static final String NCDC_HAS_HTTP_SERVER = "https://www.ncei.noaa.gov";
	public static final String NCDC_HAS_HTTP_DIRECTORY = "pub/has";
	public static final String NCDC_HAS_FTP_SERVER = "ftp.ncei.noaa.gov";
	public static final String NCDC_HAS_FTP_DIRECTORY = "pub/has";
	
	// currently set to null because there is no failover or alternate address
	public static final String NCDC_HAS_HTTP_SERVER_BACKUP = null;
	public static final String NCDC_HAS_HTTP_DIRECTORY_BACKUP = null;
