...
public class NexradSampleDimensionFactory {
	...
	private final static HashMap<String, ColorsAndValues[]> paletteOverrideMap = 
	...
	public static HashMap<String, ColorsAndValues[]> getPaletteOverride() {
		return paletteOverrideMap;
	}
